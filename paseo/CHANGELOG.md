...
- **Paseo 0.9.2.** The base image moved from `0.9.1` to `0.9.2`
  (`sha256:d413ff361bc4018d559da3d517a6d5a9eaca721fbb1b71ae8df3dcf7a965c136`). Released automatically; the add-on itself is
  unchanged since 0.9.1-1.

## 0.9.1-1

- **Paseo 0.9.1.** The base image moved from `0.9.0` to `0.9.1`
  (`sha256:9aae08258b6ff85853da3144ef48c2fd355cfe644500ca4d6041753da589098d`). Released automatically; the add-on itself is
  unchanged since 0.9.0-1.

## 0.9.0-1

- **Paseo 0.9.0.** The base image moved from `0.8.0` to `0.9.0`
  (`sha256:27962fe4d0624ae74d1a463b4fcf6dd90a82529e7f48c9ad74f972887e1dc17b`). Released automatically; the add-on itself is
  unchanged since 0.8.0-1.
